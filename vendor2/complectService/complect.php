...
// Fetch data for completed services
$sql = "
    SELECT 
        my_service.s_no,
        my_service.photo,
    ...
    WHERE 
        my_service.shop_id = ? AND my_service.status = 'complete'
";
...
<head>
    ...
    <link rel="stylesheet" href="complect.css"> <!-- Link to your CSS file -->
</head>
<body>
    ...
    <div class="sidebar">
        ...
        <li><a href="../dashboard/dashboard.php">Dashboard</a></li>
            ...
            <li><a href="complect.php">Complected Service</a></li>
    ...
    <div class="main-content">
        ...
        <div class="requests-container">
            <?php if ($result->num_rows > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p>No completed services for this shop.</p>
            <?php endif; ?>
        </div>
    </div>
</body>
